IF OBJECT_ID(N'dbo.API_LayQuyenCuaToi', N'P') IS NULL
    EXEC(N'CREATE PROCEDURE dbo.API_LayQuyenCuaToi AS RETURN 0;');
GO

ALTER PROCEDURE dbo.API_LayQuyenCuaToi
    @Username varchar(50)
AS
BEGIN
    SET NOCOUNT ON;
    ...
    SELECT 
        ...
        ISNULL(P.isAdmin, 0) AS CanAdmin
