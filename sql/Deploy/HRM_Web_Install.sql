/*
  HRM_Web_Install.sql
  Cài metadata web HRM theo kiểu ADD_ONLY mặc định.
  Nguồn đối chiếu: scriptschema.sql và scriptdataa.sql (snapshot test UTF-16LE).
...
IF OBJECT_ID('dbo.WA_Menu', 'U') IS NULL
    THROW 51430, 'HRM_Web_Install: thieu dbo.WA_Menu.', 1;
IF OBJECT_ID('dbo.SY_FrmLstTbl', 'U') IS NULL
    THROW 51431, 'HRM_Web_Install: thieu dbo.SY_FrmLstTbl.', 1;
IF OBJECT_ID('dbo.WA_API', 'U') IS NULL
    THROW 51432, 'HRM_Web_Install: thieu dbo.WA_API.', 1;
IF OBJECT_ID('dbo.SY_FormatFields', 'U') IS NULL
...
CREATE TABLE #MenuManifest (
    MenuID varchar(50) NOT NULL PRIMARY KEY,
    Parent varchar(50) NULL,
    VN nvarchar(200) NOT NULL,
    EN nvarchar(200) NULL,
    FormName varchar(100) NULL,
    FormKey varchar(50) NULL,
    ExpectedDisabled bit NOT NULL
);

/* Chỉ ghi menu HR đã bật; các menu isDisable=1 được liệt kê để báo cáo, không cài lại. */
INSERT INTO #MenuManifest (MenuID, Parent, VN, EN, FormName, FormKey, ExpectedDisabled)
VALUES
('2010', '20', N'Hồ sơ nhân viên tổng hợp', N'General Employee Profile', 'WA_PersonFullFrm', 'WA_PERSONFULLFRM', 0),
('2021', '20', N'Hợp đồng lao động', N'Labor Contracts', 'WA_HopDongLaoDongFrm', 'WA_HOPDONGLAODONGFRM', 0),
('2022', '20', N'Bảo hiểm', N'Insurance', 'WA_BaoHiemFrm', 'WA_BAOHIEMFRM', 0),
('2028', '20', N'Kinh phí công đoàn', NULL, 'WA_KinhPhiCongDoanFrm', NULL, 0),
('2102', '21', N'Bảng chấm công tổng hợp', NULL, 'WA_TimeSheetFrm', NULL, 0),
('2103', '21', N'Báo cáo chấm công chi tiết', N'Detailed Timesheet Report', 'WA_TimeSheetCTReport', NULL, 0),
('2104', '21', N'Báo cáo chấm công tổng hợp', NULL, 'WA_TimeSheetTH2Report', NULL, 0),
('2106', '21', N'Xử lý chấm công hàng ngày', N'Daily Timesheet Processing', 'WA_TimeSheetDayFrm', NULL, 0),
('2144', '21', N'Ca làm việc', N'Shift Scheduling', 'WA_CaLamViecFrm', NULL, 0),
('2201', '22', N'Báo cáo nhân sự', NULL, 'WA_BaoCaoNhanSuReport', NULL, 0),
('2202', '22', N'Báo cáo lương', N'Báo cáo chấm công', 'WA_BaoCaoLuongReport', NULL, 0),
('2204', '22', N'Báo cáo nghỉ phép', NULL, 'WA_BaoCaoNghiPhepReport', NULL, 0),
('2301', '23', N'Danh mục bộ phận / phòng ban', NULL, 'WA_DepartmentListFrm', NULL, 0),
('2302', '23', N'Danh mục chức vụ', NULL, 'WA_TitleListFrm', NULL, 0),
('2305', '23', N'Danh mục Ca làm việc', NULL, 'WA_ShiftListFrm', NULL, 0),
('2312', '23', N'Danh mục Tôn Giáo', NULL, 'WA_ReligionListFrm', NULL, 0),
('2316', '23', N'Danh mục hình thức nghỉ', NULL, 'WA_HinhThucNghiListFrm', NULL, 0),
('2317', '23', N'Danh mục chi nhánh / đơn vị', NULL, 'CF_BranchListFrm', NULL, 0),
('2318', '23', N'Danh mục Ca làm việc chi nhánh', NULL, 'WA_ShiftListCNFrm', NULL, 0),
('2352', '23', N'Danh mục chức danh', N'Danh mục chức danh', 'WA_ChucDanhFrm', NULL, 0),
('240101', '24', N'Bảng mức thuế TNCN', N'PIT Tax Bracket', 'WA_BangThueTNCNFrm', NULL, 0),
('240102', '24', N'Bảng tham số tính lương', N'Payroll Insurance Parameters', 'WA_BangThamSoFrm', NULL, 0),
('240103', '24', N'Lương khoán', N'Contractor Salary', 'WA_LuongKhoanFrm', NULL, 0),
('2402', '24', N'Bảng phụ cấp hàng tháng', N'Monthly Allowance', 'WA_BangPhuCapFrm', NULL, 0),
('2405', '24', N'Bảng tính lương tháng', N'Monthly Payroll', 'WA_PayrollFrm', 'WA_PAYROLLFRM', 0),
('2410', '24', N'Phiếu lương', NULL, 'WA_PayrollPersonReport', NULL, 0),
('3001', '30', N'Quản lý nghỉ phép năm', NULL, 'WA_QuanLyNghiPhepNamFrm', NULL, 0),
('3010', '30', N'Quản lý nghỉ lễ', NULL, 'WA_QuanLyNghiLeFrm', NULL, 0),
('3030', '30', N'Đơn xin nghỉ phép', NULL, 'WA_DonXinNghiPhepFrm', NULL, 0);

CREATE TABLE #DisabledMenuManifest (MenuID varchar(50) NOT NULL, FormName varchar(100) NOT NULL);
INSERT INTO #DisabledMenuManifest (MenuID, FormName)
VALUES
('2029', 'WA_KhenThuongFrm'), ('2030', 'WA_SuCoFrm'), ('2035', 'WA_PhucLoiFrm'),
('2040', 'WA_QuanLyNghiLeFrm'), ('2050', 'WA_DanhSachUngVienFrm'), ('2303', 'WA_PositionListFrm'),
('2304', 'WA_WorkingGroupListFrm'), ('2306', 'WA_JobListFrm'), ('2307', 'WA_HospitalListFrm'),
('2308', 'WA_BankListFrm'), ('2309', 'WA_NationListFrm'), ('2310', 'WA_ProvinceListFrm'),
('2311', 'WA_PeopleListFrm'), ('2313', 'WA_EducationListFrm'), ('2314', 'WA_BangCapListFrm'),
('2315', 'WA_CareerlListFrm');

CREATE TABLE #FormManifest (
...
('WA_HopDongLaoDongFrm', 'LIST', N'Hợp đồng lao động', N'Labor Contracts', 'HR_HopDongTbl', 'MaHopDong'),
('API_HopDongLaoDong_ChiTiet', 'LIST', N'Phụ cấp trong hợp đồng', N'Contract Allowances', 'HR_HopDongDetailTbl', 'UserAutoID'),
('API_HopDongLaoDong_Attach', 'LIST', N'Tài liệu đính kèm', N'Contract Attachments', 'HR_HopDongAttachTbl', 'UserAutoID'),
('WA_BaoHiemFrm', 'EDIT', N'Bảo hiểm', N'Insurance', 'HR_BaoHiemTbl', 'DocumentID'),
('API_BaoHiem_Detail', 'EDIT', N'Bảo hiểm chi tiết', N'Insurance Detail', 'HR_BaoHiemChiTietTbl', 'UserAutoID'),
...
('WA_DepartmentListFrm', 'EDIT', N'Danh mục phòng ban', N'Department List', 'HR_DepartmentListTbl', 'PhongBan'),
('WA_TitleListFrm', 'EDIT', N'Danh mục chức vụ', N'Job Title List', 'HR_TitleListTbl', 'TitleName'),
('WA_ShiftListFrm', 'EDIT', N'Danh mục ca làm việc', N'Shift List', 'HR_ShiftListTbl', 'ShiftID'),
('WA_HinhThucNghiListFrm', 'EDIT', N'Danh mục hình thức nghỉ', N'Leave Type List', 'HR_HinhThucNghiListTbl', 'HinhThucNghi'),
('CF_BranchListFrm', 'EDIT', N'Danh mục chi nhánh', N'Branch List', 'CF_BranchTbl', 'BranchID');

CREATE TABLE #ApiManifest (
...
INSERT INTO #ApiManifest (list, func, [SQL], Para)
VALUES
('WA_PersonFullFrm', 'View', N'API_HoSoNhanVien', N'@Keyword=N''{Keyword}'', @BranchID=N''{BranchID}'', @PhongBan=N''{PhongBan}'', @NamLap=N''{NamLap}'', @LoaiHD=N''{LoaiHD}'', @PersonStatus=N''{PersonStatus}'''),
('WA_PersonFullFrm', 'Save', N'API_LuuDong', N'@List=N''{List}'', @Data=N''{JsonData}'', @UserName=N''{User}'''),
('WA_PersonFullFrm', 'Delete', N'API_XoaDong', N'@List=N''{List}'', @Ids=N''{Ids}'', @UserName=N''{User}'', @Data=N''{JsonData}'''),
('WA_HopDongLaoDongFrm', 'View', N'API_HopDongLaoDong', N'@Keyword=N''{Keyword}'', @NamLap=N''{NamLap}'', @LoaiHD=N''{LoaiHD}'', @BranchID=N''{BranchID}'''),
('WA_HopDongLaoDongFrm', 'Save', N'API_LuuDong', N'@List=N''{List}'', @Data=N''{JsonData}'', @UserName=N''{User}'''),
('WA_HopDongLaoDongFrm', 'Delete', N'API_XoaDong', N'@List=N''{List}'', @Ids=N''{Ids}'', @UserName=N''{User}'', @Data=N''{JsonData}'''),
('WA_BaoHiemFrm', 'View', N'API_BaoHiem', N'@Keyword=N''{Keyword}'', @BranchID=N''{BranchID}'''),
('WA_BaoHiemFrm', 'Save', N'WA_BaoHiemFrm_Save', N'@List=N''{List}'', @Data=N''{JsonData}'', @UserName=N''{User}'''),
('WA_BaoHiemFrm', 'Delete', N'API_XoaDong', N'@List=N''{List}'', @Ids=N''{Ids}'', @UserName=N''{User}'', @Data=N''{JsonData}'''),
('WA_KinhPhiCongDoanFrm', 'View', N'API_KinhPhiCongDoan', N'@Keyword=N''{Keyword}'', @BranchID=N''{BranchID}'', @User=N''{User}'', @PeriodID=N''{PeriodID}'''),
('WA_KinhPhiCongDoanFrm', 'Save', N'API_LuuDong', N'@List=N''WA_KinhPhiCongDoanFrm'', @Data=N''{JsonData}'', @UserName=N''{User}'''),
('WA_KinhPhiCongDoanFrm', 'Delete', N'API_XoaDong', N'@List=N''{List}'', @Ids=N''{Ids}'', @Data=N''{JsonData}'', @UserName=N''{User}'''),
('WA_TimeSheetFrm', 'View', N'API_BangChamCongTongHop', N'@Keyword=N''{Keyword}'', @SortColumn=N''{SortColumn}'', @SortDir=N''{SortDir}'', @Data=N''{JsonData}'''),
...
('API_CaLamViec_ChiTiet', 'View', N'API_CaLamViec_ChiTiet', N'@SapCaID=N''{SapCaID}'''),
('WA_QuanLyNghiPhepNamFrm', 'View', N'API_QuanLyNghiPhepNam', N'@Keyword=N''{Keyword}'', @BranchID=N''{BranchID}'', @PhongBan=N''{PhongBan}'', @PersonName=N''{PersonName}'', @Nam=N''{Nam}'''),
('WA_QuanLyNghiPhepNamFrm', 'Save', N'API_LuuDong', N'@List=N''WA_QuanLyNghiPhepNamFrm'', @Data=N''{JsonData}'', @UserName=N''{User}'''),
('WA_QuanLyNghiPhepNamFrm', 'Delete', N'API_XoaDong', N'@List=N''{List}'', @Ids=N''{Ids}'', @Data=N''{JsonData}'', @UserName=N''{User}'''),
('API_QuanLyNghiPhepNam_ChiTiet', 'View', N'API_QuanLyNghiPhepNam_ChiTiet', N'@PersonID=N''{PersonID}'''),
('WA_DonXinNghiPhepFrm', 'View', N'API_HR_NghiPhep', N'@Keyword=N''{Keyword}'', @BranchID=N''{BranchID}'''),
('WA_DonXinNghiPhepFrm', 'Save', N'API_LuuDong', N'@List=N''WA_DonXinNghiPhepFrm'', @Data=N''{JsonData}'', @UserName=N''{User}'''),
('WA_DonXinNghiPhepFrm', 'Delete', N'API_XoaDong', N'@List=N''{List}'', @Ids=N''{Ids}'', @Data=N''{JsonData}'', @UserName=N''{User}'''),
('API_HR_NghiPhep_ChiTiet', 'View', N'API_HR_NghiPhep_ChiTiet', N'@DocumentID=N''{DocumentID}'''),
('API_HR_NghiPhep_ChiTiet', 'Save', N'API_LuuDong', N'@List=N''API_HR_NghiPhep_ChiTiet'', @Data=N''{JsonData}'', @UserName=N''{User}'''),
('API_HR_NghiPhep_ChiTiet', 'Delete', N'API_XoaDong', N'@List=N''{List}'', @Ids=N''{Ids}'', @Data=N''{JsonData}'', @UserName=N''{User}'''),
...
('WA_DepartmentListFrm', 'View', N'API_TruyVanDong', N'@List=N''{List}'', @Keyword=N''{Keyword}'', @SortColumn=N''{SortColumn}'', @SortDir=N''{SortDir}'', @Data=N''{JsonData}'''),
...
CREATE TABLE #FormatManifest (
    ...
    IsRequired bit NULL,
    FormPosition varchar(20) NULL,
    ShowInAdd bit NOT NULL,
    ShowInEdit bit NOT NULL,
    IsReadOnlyEdit bit NOT NULL,
    IsReadOnlyAdd bit NOT NULL,
...
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_PersonFullFrm', N'TitleName', N'Chức vụ', N'Title', N'sl', 0, N'grid|6', 1, 1, 0, 0, NULL, NULL, NULL, 5, 0, N'API_DanhSachChucVu');
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_PersonFullFrm', N'ChucDanhChuyenMon', N'Chức danh chuyên môn', N'Professional Title', N'sl', 0, N'grid|6', 1, 1, 0, 0, NULL, NULL, NULL, 6, 0, N'API_DanhSachChucDanh');
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_PersonFullFrm', N'NgaySinh', N'Ngày sinh', N'Date of Birth', N'd', 0, N'grid|6', 1, 1, 0, 0, NULL, NULL, NULL, 7, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_PersonFullFrm', N'CMND', N'CCCD', N'ID/Passport', N't', 0, N'grid|6', 1, 1, 0, 0, NULL, NULL, NULL, 8, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_PersonFullFrm', N'DiaChiThuongTru', N'Địa chỉ thường trú', N'Permanent Address', N't', 0, N'6', 1, 1, 0, 0, NULL, NULL, NULL, 9, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_PersonFullFrm', N'NgayVaoLam', N'Ngày nhận việc', N'Hire Date', N'd', 0, N'grid|6', 1, 1, 0, 0, NULL, NULL, NULL, 10, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_PersonFullFrm', N'BranchID', N'Chi nhánh', N'Branch', N'sl', 0, N'grid|6', 1, 1, 0, 0, NULL, NULL, NULL, 11, 1, N'CF_BranchListFrm');
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_PersonFullFrm', N'NgayHopDong', N'Ngày hợp đồng', N'Contract Date', N'd', 0, N'6', 1, 1, 0, 0, NULL, NULL, NULL, 12, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_PersonFullFrm', N'NationName', N'Quốc gia', N'Country', N't', 0, N'grid|6', 1, 1, 0, 0, NULL, NULL, NULL, 13, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_PersonFullFrm', N'SoHopDong', N'Số hợp đồng', N'Contract No', N't', 0, N'grid|6', 1, 1, 0, 0, NULL, NULL, NULL, 14, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_PersonFullFrm', N'DienThoai', N'Điện thoại', N'Phone', N't', 0, N'grid|6', 1, 1, 0, 0, NULL, NULL, NULL, 15, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_PersonFullFrm', N'PersonStatus', N'Trạng thái', N'Status', N'sl', 0, N'6', 1, 1, 0, 0, NULL, NULL, NULL, 99, 1, N'API_ComboPersonStatus');
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_PersonFullFrm', N'NewPersonID', N'Mã NV cũ', N'Old Employee ID', N't', 0, N'6', 1, 1, 0, 0, NULL, NULL, NULL, 17, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_PersonFullFrm', N'CardNo', N'Mã số thẻ', N'Card No', N't', 0, N'6', 1, 1, 0, 0, NULL, NULL, NULL, 18, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_PersonFullFrm', N'ProvineName', N'Tỉnh thành', N'City/Province', N't', 0, N'6', 1, 1, 0, 0, NULL, NULL, NULL, 19, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_PersonFullFrm', N'DiaChiHienNay', N'Địa chỉ hiện nay', N'Current Address', N't', 0, N'6', 1, 1, 0, 0, NULL, NULL, NULL, 20, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_PersonFullFrm', N'Quanly', N'Người quản lý', N'Manager', N't', 0, N'6', 1, 1, 0, 0, NULL, NULL, NULL, 21, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_PersonFullFrm', N'NgayThuViec', N'Ngày thử việc', N'Probation Date', N'd', 0, N'6', 1, 1, 0, 0, NULL, NULL, NULL, 22, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_PersonFullFrm', N'BankHolder', N'Chủ tài khoản NH', N'Bank Acc Holder', N't', 0, N'6', 1, 1, 0, 0, NULL, NULL, NULL, 23, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_PersonFullFrm', N'BankAccountNo', N'Số tài khoản NH', N'Bank Acc No', N't', 0, N'grid|6', 1, 1, 0, 0, NULL, NULL, NULL, 24, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_PersonFullFrm', N'BankName', N'Tên ngân hàng', N'Bank Name', N't', 0, N'grid|6', 1, 1, 0, 0, NULL, NULL, NULL, 25, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_PersonFullFrm', N'BankLocation', N'Chi nhánh NH', N'Bank Branch', N't', 0, N'6', 1, 1, 0, 0, NULL, NULL, NULL, 26, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_PersonFullFrm', N'SocialID', N'Số thẻ BHXH', N'Social Insurance No', N't', 0, N'6', 1, 1, 0, 0, NULL, NULL, NULL, 27, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_PersonFullFrm', N'SocialDate', N'Ngày BĐ đóng BHXH', N'SI Start Date', N'd', 0, N'6', 1, 1, 0, 0, NULL, NULL, NULL, 28, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_PersonFullFrm', N'NgayKetThucBH', N'Ngày kết thúc BHXH', N'SI End Date', N'd', 0, N'6', 1, 1, 0, 0, NULL, NULL, NULL, 29, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_PersonFullFrm', N'ShiftID', N'Ca làm việc', N'Default Shift', N'sl', 0, N'6', 1, 1, 0, 0, NULL, NULL, NULL, 30, 0, N'API_HR_DropdownShifts');
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_PersonFullFrm', N'SoTheBHYT', N'Số thẻ BHYT', N'Health Insurance No', N't', 0, N'6', 1, 1, 0, 0, NULL, NULL, NULL, 31, 0, NULL);
...
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_BaoHiemFrm', N'DateCreate', N'DateCreate', NULL, N't', 0, N'form', 0, 0, 0, 0, NULL, NULL, NULL, 99, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_BaoHiemFrm', N'PeriodID', N'Kỳ', NULL, N't', 0, N'form', 1, 1, 1, 1, NULL, NULL, NULL, 99, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_BaoHiemFrm', N'LoaiBaoHiem', N'Loại bảo hiểm', NULL, N't', 0, N'form', 1, 1, 1, 1, NULL, NULL, NULL, 99, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_BaoHiemFrm', N'BranchID', N'Chi nhánh', NULL, N'sl', 1, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 3, 0, N'CF_BranchListFrm');
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_BaoHiemFrm', N'LoaiHD', N'LoaiHD', NULL, N't', 0, N'form', 0, 0, 0, 0, NULL, NULL, NULL, 99, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_BaoHiemFrm', N'PeriodKeyID', N'Mã số', N'ID', N'sl', 1, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 4, 0, N'HR_BangThamSoTbl');
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'API_BaoHiem_Detail', N'UserAutoID', N'UserAutoID', NULL, N't', 0, N'grid', 0, 0, 0, 0, NULL, NULL, NULL, 99, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'API_BaoHiem_Detail', N'DocumentID', N'DocumentID', NULL, N't', 0, N'grid', 0, 0, 0, 0, NULL, NULL, NULL, 99, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'API_BaoHiem_Detail', N'PersonID', N'Mã nhân viên', NULL, N'sl', 1, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 1, 0, N'HR_PersonTbl');
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'API_BaoHiem_Detail', N'MucDong', N'Mức đóng', NULL, N'n', 1, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 6, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'API_BaoHiem_Detail', N'MucDongBHXHNLD', N'MucDongBHXHNLD', NULL, N'n', 0, N'grid', 1, 1, 1, 0, NULL, NULL, NULL, 7, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'API_BaoHiem_Detail', N'MucDongBHXHNSDLD', N'BHXH Công ty đóng', NULL, N'n', 0, N'grid', 1, 1, 1, 0, NULL, NULL, NULL, 8, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'API_BaoHiem_Detail', N'MucDongBHYTNLD', N'BHYT Người lao động', NULL, N'n', 0, N'grid', 1, 1, 1, 0, NULL, NULL, NULL, 9, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'API_BaoHiem_Detail', N'MucDongBHYTNSDLD', N'BHYT Công ty đóng', NULL, N'n', 0, N'grid', 1, 1, 1, 0, NULL, NULL, NULL, 10, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'API_BaoHiem_Detail', N'MucDongBHTNNLD', N'BHTN Người lao động', NULL, N'n', 0, N'grid', 1, 1, 1, 0, NULL, NULL, NULL, 11, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'API_BaoHiem_Detail', N'MucDongBHTNNSDLD', N'BHTN Công ty đóng', NULL, N'n', 0, N'grid', 1, 1, 1, 0, NULL, NULL, NULL, 12, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'API_BaoHiem_Detail', N'GhiChu', N'Ghi chú', NULL, N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 13, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'API_BaoHiem_Detail', N'BranchID', N'Chi nhánh', NULL, N't', 0, N'grid', 1, 1, 1, 0, NULL, NULL, NULL, 4, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'API_BaoHiem_Detail', N'IsNVMoi', N'NVMớiThamGiaBH', NULL, N'cb', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 14, 0, NULL);
...
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'Email', N'Email', NULL, N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 42, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'NgayNghiViec', N'Ngày nghỉ việc', NULL, N'd', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 43, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'WorkingGroupName', N'Tổ làm việc', NULL, N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 44, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'PeoplesName', N'Dân tộc', NULL, N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 45, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'ReligionName', N'Tôn giáo', NULL, N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 46, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'BankHolder', N'Chủ TK', NULL, N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 47, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'BankName', N'Tên ngân hàng', NULL, N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 48, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'BankAccountNo', N'TK Ngân hàng', NULL, N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 49, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'BankLocation', N'Chi nhánh NH', NULL, N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 50, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'CareerName', N'Trình độ', NULL, N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 51, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'EducationName', N'Học vấn', NULL, N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 52, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'HospitalName', N'Bệnh viện', NULL, N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 53, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'HonNhan', N'Hôn nhân', NULL, N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 54, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'SocialID', N'Số thẻ BHXH', NULL, N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 55, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'SocialDate', N'Ngày BĐ đóng', NULL, N'd', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 56, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'FingerData', N'FingerData', NULL, N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 57, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'FingerData2', N'FingerData2', NULL, N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 58, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'NgayThuViec', N'Ngày thử việc', NULL, N'd', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 59, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'SoHopDong', N'Số hợp đồng', NULL, N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 60, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'LoaiHopDong', N'Loại hợp đồng', NULL, N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 61, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'NgayHopDong', N'Ngày hợp đồng', NULL, N'd', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 62, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'NgayHetHopDong', N'Ngày hết HĐ', NULL, N'd', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 63, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'DungCuLamViec', N'Dụng cụ làm việc', NULL, N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 64, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'PersonStatus', N'Trạng thái', NULL, N'n', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 66, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'SoTheBHYT', N'Số thẻ HBYT', NULL, N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 67, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'ThoiGianHuongBHYT', N'TG hưởng', NULL, N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 68, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'NoiDangKyBHYT', N'Nơi Đký KCB ban đầu', NULL, N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 69, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'Quanly', N'Quản lý', NULL, N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 71, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'LocationID', N'Tỉnh thành', NULL, N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 72, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'NguoiLienHe', N'Người liên hệ', NULL, N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 73, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'MoiQuanHe', N'Mối quan hệ', NULL, N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 74, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'NguoiLienHeSoDT', N'Số ĐT người LH', NULL, N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 75, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'NgayDuKienTV', N'Ngày dự kiến thử việc', NULL, N'd', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 76, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'NgayKetThucBH', N'Ngày kết thúc BH', NULL, N'd', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 77, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'NgayXuLyCheDo', N'Ngày xử lý BH', NULL, N'd', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 78, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'TinhTrangXL', N'Tình trạng xử lý BH', NULL, N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 79, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'SoTienTamGiu', N'Tiền lương tạm giữ', NULL, N'n', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 80, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'NgayXuLyCheDo2', N'Ngày xử lý lương', NULL, N'd', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 81, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'TinhTrangXL2', N'Tình trạng xử lý lương', NULL, N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 82, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'SoTienTamGiu2', N'Tiền PC tạm giữ', NULL, N'n', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 83, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'NgayXuLyCheDo3', N'Ngày xử lý PC', NULL, N'd', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 84, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'TinhTrangXL3', N'Tình trạng xử lý PC', NULL, N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 85, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'UserCreate', N'Người tạo', NULL, N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 86, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'UserUpdate', N'Người sửa', NULL, N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 87, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'DateUpdate', N'Ngày sửa', NULL, N'd', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 88, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'DateCreate', N'Ngày tạo', NULL, N'd', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 89, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'ChamCong', N'Chấm công', NULL, N'c', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 90, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'UserID', N'Mã MCC', NULL, N'n', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 91, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'DiaChiTamTru', N'DiaChiTamTru', NULL, N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 92, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'TemporaryResidenceAddress', N'TemporaryResidenceAddress', NULL, N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 93, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'Position', N'Professional titles', NULL, N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 94, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetCTReport', N'ChucDanh', N'Chức Danh', NULL, N't', 0, N'grid', 1, 1, 0, 0, N'', N'', N'', 95, 0, N'');
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetTH2Report', N'PersonID', N'Mã nhân viên', N'Employee ID', N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 2, 1, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetTH2Report', N'PersonName', N'Họ và Tên', N'Employee Name', N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 3, 1, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetTH2Report', N'ChucDanh', N'Chức danh chuyên môn', N'Title', N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 4, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetTH2Report', N'TongCong', N'Tổng cộng', N'Total Days', N'n', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 5, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetTH2Report', N'SoNgayCongThang', N'Số ngày công tháng', N'Month Workdays', N'n', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 6, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetTH2Report', N'TongNgayDiLam', N'Tổng ngày đi làm', N'Total Workdays', N'n', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 7, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetTH2Report', N'SoNgayPhepTet', N'Số ngày phép tết', N'Tet Leave', N'n', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 8, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetTH2Report', N'PhepConLaiNam', N'Phép còn lại năm', N'Remaining Annual Leave', N'n', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 9, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetTH2Report', N'PhepPhatSinh', N'Phép phát sinh', N'Accrued Leave', N'n', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 10, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetTH2Report', N'HieuHi', N'Hiếu/Hỉ', N'Compassionate Leave', N'n', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 11, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetTH2Report', N'PhepBuLe', N'Phép bù lễ', N'Compensatory Leave', N'n', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 12, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetTH2Report', N'PhepSuDungTrongThang', N'Phép sử dụng trong tháng', N'Leave Used in Month', N'n', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 13, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetTH2Report', N'PhepDaDungLuyKe', N'Phép đã dùng lũy kế', N'Cumulative Leave Used', N'n', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 14, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetTH2Report', N'TonPhepHienTai', N'Tồn phép hiện tại', N'Current Leave Balance', N'n', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 15, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetTH2Report', N'GhiChu', N'Ghi chú', N'Notes', N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 16, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetTH2Report', N'ThangTitle', N'Kỳ báo cáo', N'Month Title', N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 17, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetTH2Report', N'SoNgayLe', N'Ngày công lễ', N'Holiday Days', N'n', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 18, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetTH2Report', N'1', N'1', N'1', N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 19, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetTH2Report', N'2', N'2', N'2', N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 20, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetTH2Report', N'3', N'3', N'3', N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 21, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetTH2Report', N'4', N'4', N'4', N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 22, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetTH2Report', N'5', N'5', N'5', N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 23, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetTH2Report', N'6', N'6', N'6', N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 24, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetTH2Report', N'7', N'7', N'7', N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 25, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetTH2Report', N'8', N'8', N'8', N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 26, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetTH2Report', N'9', N'9', N'9', N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 27, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetTH2Report', N'10', N'10', N'10', N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 28, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetTH2Report', N'11', N'11', N'11', N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 29, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetTH2Report', N'12', N'12', N'12', N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 30, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetTH2Report', N'13', N'13', N'13', N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 31, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetTH2Report', N'14', N'14', N'14', N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 32, 0, NULL);
INSERT INTO #FormatManifest (FormName, FieldName, CaptionVN, CaptionEN, FormatID, IsRequired, FormPosition, ShowInAdd, ShowInEdit, IsReadOnlyEdit, IsReadOnlyAdd, ValidateRule, DependsOn, VisibleRule, OrderNo, ShowInFilter, DataSource) VALUES (N'WA_TimeSheetTH2Report', N'15', N'15', N'15', N't', 0, N'grid', 1, 1, 0, 0, NULL, NULL, NULL, 33, 0, NULL);
...
BEGIN TRY
    ...
    SELECT 'WA_Menu', m.MenuID,
           ...
           CASE WHEN x.MenuID IS NULL THEN N'Chưa có menu theo business key.'
                WHEN x.isDisable = 1 THEN N'Menu đang tắt trong DB; migration không bật lại.'
                ELSE N'Đã có menu; không ghi đè.' END
    FROM #MenuManifest m
    LEFT JOIN dbo.WA_Menu x ON x.MenuID = m.MenuID;

    INSERT INTO #Audit (ObjectName, BusinessKey, StatusCode, Detail)
    SELECT 'WA_Menu', d.MenuID, 'DISABLED_IN_DB', N'Form ERP có isDisable=1 theo snapshot; không xem là thiếu.'
    FROM #DisabledMenuManifest d;

    INSERT INTO #Audit (ObjectName, BusinessKey, StatusCode, Detail)
    SELECT 'SY_FrmLstTbl', f.FormID,
           CASE WHEN x.FormID IS NULL THEN 'MISSING'
                WHEN ISNULL(x.TableName, '') <> f.TableName OR ISNULL(x.PrimaryKey, '') <> f.PrimaryKey THEN 'CONFLICT'
                ELSE 'IMPLEMENTED' END,
           CASE WHEN x.FormID IS NULL THEN N'Có thể thêm theo manifest đã xác nhận.'
                WHEN ISNULL(x.TableName, '') <> f.TableName OR ISNULL(x.PrimaryKey, '') <> f.PrimaryKey THEN N'Giữ nguyên row hiện hữu; cần review explicit update.'
    ...
    FROM #ApiManifest a
    OUTER APPLY (SELECT TOP (1) api.STT, api.[SQL], api.Para FROM dbo.WA_API api WHERE api.list = a.list AND api.func = a.func ORDER BY api.STT) x;

    INSERT INTO #Audit (ObjectName, BusinessKey, StatusCode, Detail)
    SELECT 'WA_API', CONCAT(api.list, ':', api.func), 'DUPLICATE_KEY', N'Có nhiều hơn một row hiện hữu; migration không chọn row để ghi đè.'
    FROM dbo.WA_API api
    INNER JOIN #ApiManifest m ON m.list = api.list AND m.func = api.func
    GROUP BY api.list, api.func
    HAVING COUNT(*) > 1;

    INSERT INTO #Audit (ObjectName, BusinessKey, StatusCode, Detail)
    SELECT 'SY_FormatFields', CONCAT(ff.FormName, ':', ff.FieldName),
           CASE WHEN x.AutoID IS NULL THEN 'MISSING'
                WHEN ISNULL(x.FormatID, '') <> ISNULL(ff.FormatID, '')
                  OR ISNULL(x.FormPosition, '') <> ISNULL(ff.FormPosition, '')
                  OR ISNULL(x.OrderNo, 0) <> ISNULL(ff.OrderNo, 0)
                  OR ISNULL(x.ShowInAdd, 0) <> ff.ShowInAdd
                  OR ISNULL(x.ShowInEdit, 0) <> ff.ShowInEdit
                  OR ISNULL(x.IsReadOnlyEdit, 0) <> ff.IsReadOnlyEdit
                  OR ISNULL(x.IsReadOnlyAdd, 0) <> ff.IsReadOnlyAdd
                  OR ISNULL(x.ShowInFilter, 0) <> ff.ShowInFilter THEN 'CONFLICT'
                ELSE 'IMPLEMENTED' END,
           CASE WHEN x.AutoID IS NULL THEN N'Có thể thêm field thiếu.'
                WHEN ISNULL(x.FormatID, '') <> ISNULL(ff.FormatID, '') THEN N'FormatID khác; không tự động suy đoán/cập nhật.'
                WHEN ISNULL(x.FormPosition, '') <> ISNULL(ff.FormPosition, '') OR ISNULL(x.OrderNo, 0) <> ISNULL(ff.OrderNo, 0) THEN N'Layout khác; giữ override hiện hữu.'
                ELSE N'Đã khớp contract.' END
    FROM #FormatManifest ff
    OUTER APPLY (
        SELECT TOP (1) f.AutoID, f.FormatID, f.FormPosition, f.OrderNo, f.ShowInAdd, f.ShowInEdit, f.IsReadOnlyEdit, f.IsReadOnlyAdd, f.ShowInFilter
        FROM dbo.SY_FormatFields f
        WHERE f.FormName = ff.FormName AND f.FieldName = ff.FieldName
        ORDER BY f.AutoID
    ) x;

    INSERT INTO #Audit (ObjectName, BusinessKey, StatusCode, Detail)
    SELECT 'SY_FormatFields', CONCAT(f.FormName, ':', f.FieldName), 'DUPLICATE_KEY', N'Có nhiều hơn một override hiện hữu; migration không tự chọn.'
    FROM dbo.SY_FormatFields f
    INNER JOIN #FormatManifest m ON m.FormName = f.FormName AND m.FieldName = f.FieldName
    GROUP BY f.FormName, f.FieldName
    HAVING COUNT(*) > 1;

    INSERT INTO #Audit (ObjectName, BusinessKey, StatusCode, Detail)
    SELECT 'SY_FormatFields', CONCAT(m.FormName, ':', m.FieldName), 'ORPHAN', N'Field manifest không có form/menu HR trong allow-list; chỉ báo cáo, không ghi.'
    FROM (SELECT DISTINCT FormName, FieldName FROM #FormatManifest) m
    ...
    FROM #Audit
    GROUP BY ObjectName, StatusCode
    ORDER BY ObjectName, StatusCode;
